...
htmls = glob.glob("*.html")                         #find all modlists
if len(htmls) == 0:
...
mods = {}
dlcs = {}
for i in range(len(htmls)):                         #read all modlists, put mod and relative number together
    print("found: " + htmls[i].removesuffix(".html"))
