...
def buildui():
    ...
    mainFrame = ttk.Frame(mainWindow, padding= 20)
    ...
    modlistList = tk.Listbox(modlistFrame, activestyle= "none", height = 6, listvariable= tk.Variable(value= modlists), yscrollcommand= modlistYScroll)
    ...
    neededModsList = tk.Listbox(neededModsFrame, activestyle= "none", height = 11, listvariable= tk.Variable(value= neededMods), yscrollcommand= neededModsYScroll)
    ...
    extraModsList = tk.Listbox(extraModsFrame, activestyle= "none", height = 11, listvariable= tk.Variable(value= extraMods), yscrollcommand= extraModsYScroll)
